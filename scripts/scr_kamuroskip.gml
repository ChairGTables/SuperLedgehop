if (state < 2)
{
    ...
    if (instance_exists(obj_kamurodialogue5))
    {
        instance_destroy(obj_kamurodialogue5);
    }
    ...
    global.musicrm1 = audio_play_sound_on (global.musicEmitter, snd_kamurofight, true, 10);
    instance_create(x, y, obj_blackfadein);
    instance_create(x, y, obj_kamuro);
