...
global.currentWholeSec   =  global.wholeSec   -
    (((currentPos * 100) % (global.wholeSec * 100))     / 100);
global.currentHalfSec    =  global.halfSec    -
    (((currentPos * 100) % (global.wholeSec * 100 / 2)) / 100);
global.currentQuarterSec =  global.quarterSec -
    (((currentPos * 100) % (global.wholeSec * 100 / 4)) / 100);
global.currentEighthSec =  global.eighthSec -
    (((currentPos * 100) % (global.wholeSec * 100 / 8)) / 100);
