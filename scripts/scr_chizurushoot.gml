...
if (instance_exists(obj_chizuru) && !instance_exists(obj_bonustheme))
{
    if (obj_chizuru.action == 1)
    {
        ...
        {
            //Yuuto attacks
            obj_chizuru.yuutoRock.direction = global.aimangle;
            obj_chizuru.yuutoRock.speed = 30;
            obj_chizuru.yuutoRock.alarm[0] = 15;
            obj_chizuru.yuutoRock.attacking = true;
            obj_chizuru.casting = true;
            obj_chizuru.sprite_index = spr_yuutoshootd;
            if (obj_chizuru.sprite_index == spr_yuutowalku)
            {
                obj_chizuru.sprite_index = spr_yuutoshootu;
            }
            image_index = 0;
